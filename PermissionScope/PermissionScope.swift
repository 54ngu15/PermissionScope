...
@objc public class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    public init(backgroundTapCancels: Bool) {
        ...
        // close button
        closeButton.setTitle("PermissionScopeCloseTitle".localized, for: .normal)
            ...
            statusForPermission(type,
                                completion: { currentStatus in
                                    ...
                                    if currentStatus == .authorized {
                                        ...
                                        button.setTitle("PermissionScopeAllowed\(prettyDescription)".localized.uppercased(), for: .normal)
                                    } else if currentStatus == .unauthorized {
                                        self.setButtonUnauthorizedStyle(button)
                                        button.setTitle("PermissionScopeDenied\(prettyDescription)".localized.uppercased(), for: .normal)
                                    } else if currentStatus == .disabled {
                                        //                setButtonDisabledStyle(button)
                                        button.setTitle("PermissionScope\(prettyDescription)Disabled".localized.uppercased(), for: .normal)
                                    }
    ...
    func permissionStyledButton(_ type: PermissionType) -> UIButton {
        ...
        case .locationAlways, .locationInUse:
            button.setTitle("PermissionScopeEnable\(type.prettyDescription)".localized.uppercased(), for: .normal)
        default:
            button.setTitle("PermissionScopeAllow\(type.prettyDescription)".localized.uppercased(), for: .normal)
        }
